 ...
 * prefix is 4,096 tokens, so the few-shot block is grown deliberately —
 * cached reads at ~10% of input price make the big prefix cheaper per
 * call than a small uncached one. Verify cache_read_input_tokens > 0
 * at deploy (T16).
 */
