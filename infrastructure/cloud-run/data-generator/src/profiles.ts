...
const ecommerceChannels: ChannelConfig[] = [
  {
    ...
    campaigns: [
      ...
      {
        name: 'Google - Prospecting - Small Dog Owners',
        utmVariants: [
          'google_prosp_smalldogs',
          'Google Prospecting Small Dog Owners',
          'g_prospect_small-dogs',
        ],
        monthlySpend: 600,
        avgCpc: 0.55,
        ctr: 0.03,
  ...
  },
  {
    ...
    campaigns: [
      ...
      {
        name: 'Meta - Broad - Dog Content',
        utmVariants: [
          'meta_broad_dogcontent',
          'FB Broad Dog Content',
          'META_BROAD_DOG',
          'meta-broad-dog-content',
        ],
        monthlySpend: 700,
        avgCpc: 0.4,
        ctr: 0.015,
...
const subscriptionChannels: ChannelConfig[] = [
  {
    ...
    campaigns: [
      ...
      {
        name: 'Google - Search - Dog Subscription Box',
        utmVariants: [
          'google_search_dogsub',
          'Google Search - Dog Subscription Box',
          'g_srch_dog_sub_box',
        ],
        monthlySpend: 900,
        avgCpc: 0.65,
