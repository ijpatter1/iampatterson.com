    ...
    <div className="space-y-8">
      ...
      <section className="rounded-card border border-border bg-surface-alt p-6">
        ...
        <p className="text-xs leading-relaxed text-content-secondary">
          ...
          <span className="font-mono">mart_customer_ltv</span>. The live Metabase dashboard at{' '}
          <span className="font-mono">bi.iampatterson.com</span> connects directly to these tables
          and refreshes automatically. The insight is generated by analyzing conversion rates
          segmented by user journey attributes.
        </p>
      </section>
    </div>
  );
