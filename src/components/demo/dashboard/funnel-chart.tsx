          ...
          <div key={step.label}>
            <div className="mb-1 flex items-center justify-between text-sm">
              ...
              <span className="font-medium text-ink">
                ...
                <span className="ml-1 text-xs text-ink-3">({step.percentage.toFixed(1)}%)</span>
              </span>
            </div>
            <div className="h-6 w-full rounded bg-paper-alt">
              <div
                className="h-6 rounded bg-ink transition-all"
