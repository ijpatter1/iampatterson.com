  ...
  return (
    <div className="mx-auto max-w-lg py-12 text-center">
      ...
      <p className="text-sm leading-relaxed text-neutral-600">
        ...
        categorized by partnership type, and attributed to the channel that brought you here. Flip
        the card to see the full journey from your first page view to qualified lead.
      </p>
      <Link
        href="/demo/leadgen"
