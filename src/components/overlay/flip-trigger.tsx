...
export function FlipTrigger() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-neutral-200 bg-white shadow-card transition-all hover:shadow-elevated hover:border-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 md:bottom-8 md:right-8"
    >
      <svg
        width="20"
        height="20"
