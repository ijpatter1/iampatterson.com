...
# across setup-iam.sh / deploy.sh, and the load-balancer + IAP shell now
# declared in infrastructure/terraform/metabase-lb.tf (the two one-shots that
# provisioned it were retired in [14.2]).
